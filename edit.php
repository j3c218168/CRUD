...
<body class="bg-light">
    ...
    <nav class="navbar  sticky-top">
        <div class="container-fluid">
            ...
            <a href="index.php">
                ...
                <label for="simpan">
                    <button class="btn btn-primary" name="update" form="data" id="update">
                        Update
                    </button>
                </label>
    ...
    <div class="container-fluid ">
        <div class="container w-75 bg-white my-5 shadow rounded ">
            <div class="row">
                <div class="col">
                    <h2 class="pt-3 pb-1 border-bottom">Ubah Data</h2>
                </div>
            </div>

            <form method="POST" enctype="multipart/form-data" action="update.php" id="data">
                ...
                <div class="row">
                    <div class="col-8" style="overflow-y: scroll; height: 60vh;">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                <input type="text" name="nim" class="form-control" id="form-nim" value="J3C218168">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="form-nama" class="font-weight-bold">Nama Lengkap</label>
                            <input type="text" name="nama" class="form-control" id="form-nama" value="Maria Veronica Sihotang">
                        </div>
                        ...
                        <div class="form-group" id="form-sex">
                            ...
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label" for="P">Laki - Laki</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="P" name="sex" value="P" checked >
                        ...
                        <div class="form-group" id="form-hobi">
                            <label for="form-hobi" class="font-weight-bold">Membaca</label>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="hobi[]" id="baca" value="Membaca" checked >
                                <label class="custom-control-label" for="baca">Membaca</label>
                            </div>

                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="hobi[]" id="tulis" value="Menulis" checked >
                                <label class="custom-control-label" for="tulis">Menulis</label>
                            </div>

                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="hobi[]" id="gambar" value="Menggambar " checked>
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="hobi[]" id="anime" value="Menonton Anime" checked>
