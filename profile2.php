                ...
                <div class="row">
                    <div class="col-8" style="overflow-y: scroll; height: 60vh;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="hobi" class="form-control" id="form-nama" value="Menulis"readonly>
                            <input type="text" name="hobi" class="form-control" id="form-nama" value="Menonton Anime"readonly>
                    ...
                    <div class="col">
                        <div class="row m-auto">
                            <div class="col m-auto text-center">
                                <img class="m-auto bg-dark" src="J3X65298.jpg" style="height: 100%; width: 100%;">
                            </div>
                        </div>
                    </div>
                </div>
